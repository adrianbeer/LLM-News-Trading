...
%		- ignore.		
%	
%	- We need that algo anyway for evaluation.
%		- split is always overnight (?)
%		- use close and next open for slip detection
%		- check that price is close to adjusted daily price at the end
